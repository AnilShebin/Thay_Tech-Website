...
        </div>
        ...
        <div className="relative h-screen overflow-hidden fade-in-section">
  <div className="absolute inset-0 bg-cover bg-center blur-sm" style={{ backgroundImage: "url('/development/software_development/Soft-img5.jpg')" }}></div>
  <div className="relative z-10 flex items-center justify-center h-full  font-body">
    <div className="blur-content p-10 bg-white bg-opacity-80">
