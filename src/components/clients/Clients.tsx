...
const slidesData = [
  {
    ...
    description:
      "Thay technologies is the best place to learn and explore latest technologies on Oracle. Srini is the best mentor and I'm grateful for all learning that I've got from him. He goes above and beyond just teaching and provides career guidance with personal care.",
    name: "Anna Smith",
    position: "Senior Web Designer",
  },
  {
    imgSrc: "/Client-Logos/tata-consultancy-services.avif",
    testimonial: "Great learning environment!",
    description:
      "I take immense pride in presenting myself as ex-Thai Technology associate, who has learned Oracle RAC, Goldengate and Oracle apps DBA from Srinivasan (Srini).",
    name: "Jane Smith",
...
const Clients = () => {
  ...
  // Manually handle slide change via back and next buttons
          ...
          >
            ...
            <div className="flex items-center mt-8">
              <ButtonBack
                ...
                onClick={handleSlideBack} // Custom handler
              >
                <img
              ...
              <ButtonNext
                ...
                className="cursor-pointer"
                onClick={handleSlideNext} // Custom handler
              >
                <img
        ...
        <div className="relative z-10 xl:px-20 px-8 py-20 2xl:mx-auto 2xl:container flex flex-col">
          <div className="flex flex-wrap items-center mb-8">
            <div className="w-full md:w-1/2 mb-4 md:mb-0">
              ...
              <h2
                className="text-3xl mb-2 mr-4 text-justify text-gray-600"
                style={{ fontSize: "18px" }}
              >
